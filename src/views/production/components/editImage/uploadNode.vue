<template>
  <div class="uploadNode">
    ...
    <div class="data">
      ...
      <t-button variant="outline" @click="uploadFn">{{ $t("workbench.production.editImage.uploadAssetImage") }}</t-button>
              <t-button variant="outline" @click="getStoryboardImage">{{ $t("workbench.production.preview.exportFilename") }}</t-button>
            </div>
          </template>
        </t-dropdown>
