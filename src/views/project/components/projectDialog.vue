...
const DEFAULT_TAB_DATA: () => Data[] = () => [
  ...
  { label: $t("legacy.prefix"), value: "prefix", data: "" },
  { label: $t("workbench.assets.role"), value: "art_character", data: "" },
  { label: $t("legacy.roleDerivative"), value: "art_character_derivative", data: "" },
  { label: $t("workbench.assets.prop"), value: "art_prop", data: "" },
  { label: $t("legacy.propDerivative"), value: "art_prop_derivative", data: "" },
  { label: $t("workbench.assets.scene"), value: "art_scene", data: "" },
  { label: $t("legacy.sceneDerivative"), value: "art_scene_derivative", data: "" },
  { label: $t("workbench.generate.storyboard"), value: "director_storyboard", data: "" },
  { label: $t("legacy.storyboardVideo"), value: "art_storyboard_video", data: "" },
  { label: $t("legacy.directorPlanningStyle"), value: "director_planning_style", data: "" },
  { label: $t("legacy.storyboardTableStyle"), value: "director_storyboard_table_style", data: "" },
];
...
const DIRECTOR_DEFAULT_TAB_DATA: () => Data[] = () => [
  { label: "README", value: "README", data: "" },
  { label: $t("legacy.directorPlanning"), value: "director_planning_narrative", data: "" },
  { label: $t("workbench.production.node.storyboardTable.title"), value: "director_storyboard_table_narrative", data: "" },
];
